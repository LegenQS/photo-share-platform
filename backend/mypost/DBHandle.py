...
class DBHandle:
    ...
    def update_item(self, key, feature):
        ...
        # -----------------------------------
        avail_list = ['mypost', 'mylike', 'like_id_group', 'liked_id_group', 'hist_context', 'hist_label']
        ...
        # if attribute == 'search_history':
        #     response = self.lookup([key])
        #     try:
